...
class TestTransformation:
    ...
    def test_relatorio_filtra_2025_status_false_e_fraude_false(self, spark):
        ...
        pagamentos = spark.createDataFrame([
            ("p1", " pix ", Decimal("200.00"), False, "2025-01-01", (False, Decimal("0.1000"))),
            ("p2", "boleto", Decimal("300.00"), False, "2024-01-01", (False, Decimal("0.2000"))),
        ], SCHEMA_PAGAMENTOS)
    ...
    def test_soma_multiplos_itens_do_mesmo_pedido(self, spark):
        ...
        pagamentos = spark.createDataFrame([
            ("p1", "cartao", Decimal("250.00"), False, "2025-02-01", (False, Decimal("0.1000"))),
        ], SCHEMA_PAGAMENTOS)
    ...
    def test_exclui_pagamento_aprovado_ou_fraudulento(self, spark):
        ...
        pagamentos = spark.createDataFrame([
            ("p1", "pix", Decimal("100.00"), True, "2025-01-01", (False, Decimal("0.1000"))),
            ("p2", "pix", Decimal("100.00"), False, "2025-01-01", (True, Decimal("0.9000"))),
        ], SCHEMA_PAGAMENTOS)
